  ...
  {!! Form::open(['route' => ['pagos.update', $pago], 'autocomplete' => 'off', 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
    <div class="box-body">
      ...
      <div class="form-group{{ $errors->has('anio_id') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-6">
          {!! Form::select('anio_id', $anios, $pago->anio_id, ['class' => 'form-control select2', 'placeholder' => '-- Seleccione un año --', 'style' => 'width: 100%', 'required']) !!}
      ...
      <div class="form-group{{ $errors->has('mes') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-6">
          {!! Form::select('mes', [
            ...
            '11' => 'Noviembre',
            '12' => 'Diciembre',
            ], $pago->mes, ['class' => 'form-control select2', 'placeholder' => '-- Seleccione un mes --', 'style' => 'width: 100%', 'required']) !!}
          @if ($errors->has('mes'))
